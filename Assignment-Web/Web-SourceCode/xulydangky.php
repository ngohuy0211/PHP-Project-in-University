...
<?php
	...
	if (isset($_POST['user']) && isset($_POST['pass'])) 
	{
		...
		//tao cau truy van
		$sql = mysql_query("INSERT INTO account (username, password) VALUE ('$user', '$pass')");
		//chay cau truy van
	    if ($sql)
	        echo "Registration is successfull!. <a href='dangnhap.html'>Come to Log-In</a>";
	    else
	        echo "Registration is fail!. <a href='dangky.html'>Try again!</a>";
	}
?>
</body>
</html>